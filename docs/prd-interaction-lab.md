...
- 2026-07-16 远端内容分支与 `main` 已完成快进，main 自动 Production 为 Ready 并接管正式别名；正式别名上的 Blog 与黑桃奢案例再次通过移动端 200、正确标题、无横向滚动和 0 pageerror 复核。部署 ID 不作为版本化规格，避免文档提交触发的新部署使自身证据过期。
